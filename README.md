...
```
python -u main.py --epochs 32 --dropouth 0.1 --dropouti 0.1 --dropout 0.1 --data data/enwik8/ --save temp.pt --log-interval 20 --seed 123 --optimizer lamb --bptt 1024 --warmup 500 --lr 4e-3 --emsize 1024 --nhid 4096 --memsize 5120 --nlayers 4 --batch_size 32
```
